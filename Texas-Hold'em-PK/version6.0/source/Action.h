...
extern ActionStatue g_own_last_action; 
...
extern uint16_t g_now_jetton;//每局更新所剩筹码 
extern int g_game_Num;//总局数  
extern Opponent_Action_Infos g_opp_act_info[8];//对手动作记录
